...
parser.add_argument('--Anno_root', default=SIXray_ROOT,
                    help='Location of SIXray Anno directory')
parser.add_argument('--Image_root', default=SIXray_ROOT,
                    help='Location of SIXray Image directory')
...
annopath = args.Anno_root
imgpath = args.Image_root
...
def voc_eval(detpath,
    ...
    if not os.path.isfile(cachefile):
        ...
        for i, imagename in enumerate(imagenames):
            ...
            recs[imagename] = parse_rec(f'{annopath}{imagename}.txt', f'{imgpath}{imagename}.jpg')
            '''
            if i % 100 == 0:
...
if __name__ == '__main__':
    ...
    for EPOCH in EPOCHS:
        ...
        # load data
        dataset = SIXrayDetection(args.SIXray_root, args,
